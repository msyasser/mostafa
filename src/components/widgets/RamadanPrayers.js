...
export default function RamadanPrayers({ theme = "dark", defaultCity = "", isPreview = false, isExplorer = false }) {
    ...
    return (
        <motion.div
            ...
            className={`relative overflow-hidden rounded-3xl border p-6 shadow-2xl backdrop-blur-md transition-all duration-500 max-w-md mx-auto min-h-[400px] flex flex-col justify-center ${containerClasses}`}
        >
